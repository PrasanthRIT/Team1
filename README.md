...
that lead to unexpected delays or latencies for the trips. The system helps students view real-time bus availability, 
book rides based on their commuter plans, and avoid missing buses due to miscommunication. For drivers,
it provides confirmed passenger lists for each trip, eliminating unnecessary waiting
